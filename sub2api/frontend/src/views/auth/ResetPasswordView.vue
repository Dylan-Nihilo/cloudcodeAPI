  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div v-if="isInvalidLink" class="space-y-6">
        <div class="rounded-sm border border-danger/30 bg-danger/[0.04] p-5">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button
              ...
              class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-subtle hover:text-ink transition-colors"
            >

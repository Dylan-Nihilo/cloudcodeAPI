  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div
        ...
        class="rounded-sm border border-warning/30 bg-warning/[0.06] p-3.5"
      >
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="text-subtle" />
            </div>
            <input
              id="password"
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-success' : 'text-subtle'" />
            </div>
            <input
              id="invitation_code"
              ...
              :class="{
                '!border-success/60 focus:!border-success/60 focus:!ring-success/15': invitationValidation.valid,
                '!border-danger/60 focus:!border-danger/60 focus:!ring-danger/15': invitationValidation.invalid || errors.invitation_code
              }"
          ...
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-success/[0.06] px-3 py-2">
        ...
        <div v-if="promoCodeEnabled">
          <label for="promo_code" class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-subtle">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-success' : 'text-subtle'" />
            </div>
            <input
              id="promo_code"
              ...
              class="input pl-11 pr-10"
              :class="{
                '!border-success/60 focus:!border-success/60 focus:!ring-success/15': promoValidation.valid,
                '!border-danger/60 focus:!border-danger/60 focus:!ring-danger/15': promoValidation.invalid
              }"
          ...
          <transition name="fade">
            <div v-if="promoValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-success/[0.06] px-3 py-2">
    ...
    <template #footer>
      <p class="text-gray-500 dark:text-dark-400">
        ...
        <router-link
          to="/login"
          class="text-ink hover:underline underline-offset-4"
        >
          {{ t('auth.signIn') }}
        </router-link>
      </p>
...
const siteName = ref<string>('CloudCodeAPI')
...
onMounted(async () => {
  try {
    ...
    // Brand display is decoupled from sub2api's stored site_name; always use the product name.
    siteName.value = 'CloudCodeAPI'

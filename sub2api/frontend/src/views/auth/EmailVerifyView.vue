  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <form v-else @submit.prevent="handleVerify" class="space-y-5">
        ...
        <div
          v-if="codeSent"
          class="rounded-sm border border-success/30 bg-success/[0.06] p-3.5"
        >
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0">
        ...
        <div class="text-center">
          <button
            ...
            type="button"
            disabled
            class="cursor-not-allowed text-sm text-subtle"
          >
          ...
          <button
            ...
            "
            class="text-sm text-ink hover:underline underline-offset-4 disabled:cursor-not-allowed disabled:opacity-50"
          >
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'CloudCodeAPI'

  ...
  <AppLayout>
      ...
      <template #table>
        ...
        >
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    "
                    class="mx-1 text-muted dark:text-muted"
                    >·</span
                  >
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-ink/5 px-1.5 py-0.5 font-medium text-ink"
              ...
              <div>
                ...
                <span
                  class="ml-1 font-medium text-ink"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-subtle">—</div>
            <div v-else class="space-y-0.5 text-xs">
              <div class="text-muted">
                <span class="text-subtle">{{
                  t("admin.groups.usageToday")
                }}</span>
                <span class="ml-1 font-medium text-ink"
                  >${{
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-ink/5 hover:text-ink dark:hover:text-ink"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-danger/[0.04] hover:text-danger"
              >
    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-subtle transition-colors hover:text-ink dark:text-muted"
              />
              <div
              ...
              >
                <div
                  class="rounded-lg bg-ink p-3 text-paper shadow-medium"
                >
          ...
          >
            <span
              ...
              :key="groupId"
              class="inline-flex items-center gap-1 rounded-full bg-ink/10 px-2.5 py-1 text-xs font-medium text-ink"
            >
              {{
              ...
              <button
                ...
                "
                class="ml-0.5 text-ink hover:text-ink"
              >
                <Icon name="x" size="xs" />
              </button>
            </span>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <div class="rounded bg-ink/95 p-2">
                    <p class="text-xs leading-relaxed text-muted">
                      <span
                        class="inline-flex items-center gap-1 text-ink"
        ...
        >
          <label
            class="block mb-2 font-medium text-ink"
          >
          ...
          <div class="space-y-2">
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                ...
                class="h-4 w-4 rounded-sm border-border text-ink accent-ink focus:ring-ink/30"
              />
              <span class="text-sm text-ink">{{
        ...
        >
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            ...
            >
              <div
                class="border-b border-border bg-ink/[0.02]/80 px-4 py-3/50"
              >
                <div class="flex items-center gap-2">
                  <div class="h-2 w-2 rounded-full bg-ink/[0.04]0"></div>
                  <label
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-md border border-border bg-surface shadow-soft"
            >
              <div
                class="border-b border-border bg-ink/5 px-4 py-3"
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    <div class="flex items-center gap-2">
                      <div class="h-2 w-2 rounded-full bg-ink/50"></div>
                      <label
                        class="text-sm font-medium text-ink"
                        >{{
                    ...
                    <p
                      class="mt-1 text-xs text-ink/90 dark:text-ink/90"
                    >
              ...
              <div class="p-4 bg-ink/[0.02]/30/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-md border border-dashed border-border bg-surface px-5 py-4 text-sm text-ink transition-colors hover:border-ink/40"
                >
                  <span>{{
                  ...
                  <button
                    ...
                    class="flex items-center gap-1.5 text-sm font-medium text-ink transition-colors hover:opacity-80"
                  >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-md border border-border bg-surface p-4 shadow-soft transition-colors hover:border-ink/40"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-ink/[0.02] focus:bg-surface"
                          />
                        </div>
                        <div
                          class="hidden md:flex md:justify-center md:pt-7 text-subtle"
                        >
                          <Icon
                            name="arrowRight"
                            size="sm"
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-subtle transition-colors hover:bg-danger/[0.04] hover:text-danger"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-md border border-dashed border-border bg-surface py-3 text-sm font-medium text-muted transition-colors hover:border-ink/40 hover:text-ink hover:bg-ink/5"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
            ...
            >
              <div class="flex items-start gap-3">
                    ...
                    <div class="relative account-search-container">
                      ...
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-ink/5"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-subtle hover:text-danger transition-colors"
          ...
          <button
            ...
            class="mt-3 flex items-center gap-1.5 text-sm text-ink hover:opacity-80"
          >
            <Icon name="plus" size="sm" />
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-border bg-surface p-3 transition-shadow hover:shadow-md active:cursor-grabbing"
          >
            ...
            <div class="text-sm text-subtle">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>

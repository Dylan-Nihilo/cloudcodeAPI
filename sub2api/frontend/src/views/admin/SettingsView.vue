          ...
          <div class="space-y-4 p-6">
            ...
            <template v-if="form.payment_enabled">
              ...
              <div class="grid grid-cols-3 gap-3">
                <div><label class="input-label">{{ t('admin.settings.payment.productNamePrefix') }}</label><input v-model="form.payment_product_name_prefix" type="text" class="input" placeholder="CloudCodeAPI" /></div>

<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-md border border-border bg-ink/5 p-3"
      >
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-lg bg-ink/5"
          >
            <Icon name="chartBar" size="md" class="text-paper" :stroke-width="2" />
          </div>
          <div>
            <div class="font-semibold text-inktext-paper">{{ account.name }}</div>
            <div class="text-xs text-mutedtext-subtle">
        ...
        <span
          :class="[
            ...
            account.status === 'active'
              ? 'bg-success/10 text-successbg-success/[0.06]0/20text-success'
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-success/30 bg-success/[0.04] p-4"
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-success/10 p-1.5">
                <svg
                  class="h-4 w-4 text-successtext-success"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div
            class="card border-border bg-ink/[0.04] p-4"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-mutedtext-subtle">{{
                t('admin.accounts.stats.totalRequests')
              }}</span>
              <div class="rounded-lg bg-ink/10 p-1.5">
                <Icon name="bolt" size="sm" class="text-inktext-ink" :stroke-width="2" />
              </div>
            </div>
            <p class="text-2xl font-bold text-inktext-paper">
          ...
          <!-- Daily Average Cost -->
          <div
            class="card border-warning/30 bg-warning/[0.06] p-4"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-mutedtext-subtle">{{
              ...
              <div class="rounded-lg bg-warning/10 p-1.5">
                <Icon
                  name="calculator"
                  size="sm"
                  class="text-warningtext-warning"
                  :stroke-width="2"
                />
              </div>
            </div>
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-ink/10 p-1.5">
                <svg
                  class="h-4 w-4 text-inktext-ink"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              ...
              <span class="text-sm font-semibold text-inktext-paper">{{
                t('admin.accounts.stats.todayOverview')
              }}</span>
            </div>
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-mutedtext-subtle">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-inktext-paper"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-mutedtext-subtle">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-inktext-paper"
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-ink/10 p-1.5">
                <Icon name="cube" size="sm" class="text-ink" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-inktext-paper">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-danger/10 p-1.5">
                <Icon name="bolt" size="sm" class="text-danger" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-inktext-paper">{{
        ...
        <!-- Usage Trend Chart -->
        <div class="card p-4">
          <h3 class="mb-4 text-sm font-semibold text-inktext-paper">
          ...
          <div class="h-64">
            ...
            <div
              v-else
              class="flex h-full items-center justify-center text-sm text-mutedtext-subtle"
            >
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-mutedtext-subtle"
      >
    ...
    <template #footer>
      <div class="flex justify-end">
        <button
          @click="handleClose"
          class="rounded-lg bg-ink/5 px-4 py-2 text-sm font-medium text-ink transition-colors hover:bg-ink/10text-subtle"
        >
          {{ t('common.close') }}
        </button>
      </div>

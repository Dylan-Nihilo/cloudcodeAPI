  ...
  >
    ...
    >
      ...
      <div v-if="account.platform === 'antigravity'" class="border-t border-border pt-4">
        ...
        <div>
          <div class="mb-3 rounded-lg bg-ink/[0.04] p-3">
            <p class="text-xs text-inktext-ink">{{ t('admin.accounts.mapRequestModels') }}</p>
          </div>
        ...
        <div v-if="account?.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-not-allowed items-center gap-2 opacity-60">
            <input
              ...
              disabled
              class="h-4 w-4 cursor-not-allowed rounded border-border text-paper0 focus:ring-ink/30"
            />

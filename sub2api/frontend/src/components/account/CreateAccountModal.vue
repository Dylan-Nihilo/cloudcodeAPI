<template>
  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-ink/50 text-paper' : 'bg-ink/10 text-muted'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-inktext-subtle">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-ink/5" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-ink/50 text-paper' : 'bg-ink/10 text-muted'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex rounded-lg bg-ink/5 p-1" data-tour="account-form-platform">
          <button
            type="button"
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-surface text-success shadow-smtext-success'
                : 'text-muted hover:text-ink'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-surface text-ink shadow-smtext-ink'
                : 'text-muted hover:text-ink'
            ]"
          >
            <svg
          ...
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ? 'bg-warning/[0.06]0 text-paper'
                  : 'bg-ink/5 text-mutedtext-subtle'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
            <div>
              <span class="block text-sm font-medium text-inktext-paper">{{
                t('admin.accounts.claudeCode')
              }}</span>
              <span class="text-xs text-mutedtext-subtle">{{
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ? 'border-border bg-ink/[0.04]'
                : 'border-border hover:border-borderhover:border-border'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-border hover:border-warning/40hover:border-warning/30'
            ]"
          >
            <div
              :class="[
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-border hover:border-success/40hover:border-success/30'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-inktext-paper">OAuth</span>
              <span class="text-xs text-mutedtext-subtle">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-inktext-paper">API Key</span>
              <span class="text-xs text-mutedtext-subtle">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-ink hover:bg-ink/[0.04]text-ink"
          >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-border hover:border-ink/40hover:border-ink/40'
            ]"
          >
            <div
              :class="[
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-border bg-ink/[0.04] px-3 py-2 text-xs text-ink"
        >
          <p>{{ t('admin.accounts.gemini.accountType.apiKeyNote') }}</p>
          <div class="mt-2 flex flex-wrap gap-2">
            <a
              :href="geminiHelpLinks.apiKey"
              class="font-medium text-ink hover:underlinetext-ink"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-ink/10 px-2 py-0.5 text-[10px] font-semibold text-ink"
                  >
                    推荐个人用户
                  </span>
                  <span
                    class="rounded bg-success/10 px-2 py-0.5 text-[10px] font-semibold text-success"
                  >
                    无需 GCP
                  </span>
                </div>
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-mutedtext-subtle">
                  需要激活 GCP 项目并绑定信用卡
                  <a
                    :href="geminiHelpLinks.gcpProject"
                    class="ml-1 text-ink hover:underlinetext-ink"
                    target="_blank"
                    rel="noreferrer"
                  >
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-muted hover:text-ink"
            >
              <svg
          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-warning/10 px-2 py-0.5 text-[10px] font-semibold text-warning"
                  >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded bg-warning/10 px-2 py-0.5 text-xs text-warning"
              >
            ...
            <div
              v-if="!geminiAIStudioOAuthEnabled"
              class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-warning/30 bg-warning/[0.06] px-3 py-2 text-xs text-warning opacity-0 shadow-lg transition-opacity group-hover:opacity-100"
            >
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-inktext-paper">OAuth</span>
              <span class="text-xs text-mutedtext-subtle">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-inktext-paper">API Key</span>
              <span class="text-xs text-mutedtext-subtle">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-border pt-4">
        ...
        <div>
          <div class="mb-3 rounded-lg bg-ink/[0.04] p-3">
            <p class="text-xs text-inktext-ink">
            ...
            >
              <div class="flex items-center gap-2">
                <input
                  ...
                  :class="[
                    'input flex-1',
                    !isValidWildcardPattern(mapping.from) ? 'border-danger/60border-danger/60' : ''
                  ]"
                  :placeholder="t('admin.accounts.requestModel')"
                />
                <svg class="h-4 w-4 flex-shrink-0 text-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input
                  ...
                  :class="[
                    'input flex-1',
                    mapping.to.includes('*') ? 'border-danger/60border-danger/60' : ''
                  ]"
                ...
                <button
                  ...
                  class="rounded-lg p-2 text-danger transition-colors hover:bg-danger/[0.04] hover:text-danger"
                >
          ...
          <button
            ...
            class="mb-3 w-full rounded-lg border-2 border-dashed border-border px-4 py-2 text-muted transition-colors hover:border-ink/40 hover:text-ink"
          >
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            <input
              ...
              type="radio"
              value="oauth"
              class="mr-2 text-ink focus:ring-ink/30"
            />
            <span class="text-sm text-inktext-subtle">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
              ...
              class="mr-2 text-ink focus:ring-ink/30"
            />
            <span class="text-sm text-inktext-subtle">{{
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-border pt-4">
          ...
          <div
            ...
            class="mb-3 rounded-lg bg-warning/[0.06] p-3"
          >
            <p class="text-xs text-warningtext-warning">
          ...
          <template v-else>
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'whitelist'
                    ? 'bg-ink/10 text-inktext-ink'
                    : 'bg-ink/5 text-muted hover:bg-ink/10text-subtle'
                ]"
              >
                <svg
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              ...
              <p class="text-xs text-mutedtext-subtle">
            ...
            <div v-if="modelMappings.length > 0" class="mb-3 space-y-2">
              ...
              >
                ...
                />
                <svg
                  class="h-4 w-4 flex-shrink-0 text-subtle"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="border-t border-border pt-4">
          <div class="mb-3 flex items-center justify-between">
            <div>
              ...
              <p class="mt-1 text-xs text-mutedtext-subtle">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                poolModeEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="poolModeEnabled" class="rounded-lg bg-ink/[0.04] p-3">
            <p class="text-xs text-inktext-ink">
        ...
        <div class="border-t border-border pt-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            <div class="rounded-lg bg-warning/[0.06] p-3">
              <p class="text-xs text-warningtext-warning">
              ...
              <button
                ...
                :class="[
                  ...
                  selectedErrorCodes.includes(code.value)
                    ? 'bg-danger/10 text-danger ring-1 ring-red-500text-danger'
                    : 'bg-ink/5 text-muted hover:bg-ink/10text-subtle'
                ]"
              >
            ...
            <div class="flex flex-wrap gap-1.5">
              <span
                ...
                :key="code"
                class="inline-flex items-center gap-1 rounded-full bg-danger/10 px-2.5 py-0.5 text-sm font-medium text-dangertext-danger"
              >
                {{ code }}
                <button
                  type="button"
              ...
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-subtle">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-ink focus:ring-ink/30"
              />
              <span class="text-sm text-inktext-subtle">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-ink focus:ring-ink/30"
              />
              <span class="text-sm text-inktext-subtle">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="rounded border-border text-ink focus:ring-ink/30"
            />
            <span class="text-sm text-inktext-subtle">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
        ...
        <div class="border-t border-border pt-4">
          ...
          <div v-else class="space-y-3">
            <div v-for="(mapping, index) in modelMappings" :key="index" class="flex items-center gap-2">
              ...
              <button type="button" @click="modelMappings.splice(index, 1)" class="text-danger hover:text-danger">
      ...
      <div class="border-t border-border pt-4 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          <div class="rounded-lg bg-ink/[0.04] p-3">
              <p class="text-xs text-inktext-ink">
                <Icon name="exclamationTriangle" size="sm" class="mr-1 inline" :stroke-width="2" />
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-ink/5 px-3 py-1.5 text-xs font-medium text-muted transition-colors hover:bg-ink/10text-subtle"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            ...
            >
              <div class="mb-2 flex items-center justify-between">
                <span class="text-xs font-medium text-mutedtext-subtle">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-subtle transition-colors hover:text-muted disabled:cursor-not-allowed disabled:opacity-40hover:text-subtle"
                  >
                  ...
                  <button
                    ...
                    class="rounded p-1 text-danger transition-colors hover:text-danger"
                  >
                    <Icon name="x" size="sm" :stroke-width="2" />
                  </button>
                </div>
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-border px-4 py-2 text-sm text-muted transition-colors hover:border-ink/40 hover:text-ink"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                windowCostEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-mutedtext-subtle">$</span>
                <input
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-mutedtext-subtle">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div class="mt-4">
            ...
            <p class="mt-1 text-xs text-mutedtext-subtle mb-2">
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ...
                    : 'bg-surface text-inktext-subtle border-border hover:bg-ink/[0.02]'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-border bg-surface px-3 py-2 text-sm shadow-sm focus:border-ink focus:outline-none focus:ring-1 focus:ring-ink/30text-paper"
            >
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-ink' : 'bg-ink/10'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ink/30 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-ink' : 'bg-ink/10'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded border-border text-paper0 focus:ring-ink/30"
            />
            <span class="text-sm font-medium text-inktext-subtle">
              {{ t('admin.accounts.mixedScheduling') }}
            </span>
          </label>
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-ink/10 text-xs text-muted hover:bg-ink/10text-subtle"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-ink px-3 py-2 text-xs text-paper opacity-0 transition-opacity group-hover:opacity-100"
            >
              {{ t('admin.accounts.mixedSchedulingTooltip') }}
              <div
                class="absolute bottom-full left-3 border-4 border-transparent border-b-gray-900border-b-gray-700"
              ></div>
            </div>
          </div>
        </div>
  ...
  >
    <div class="space-y-6">
      <!-- Setup Guide Section -->
      <div>
        <h3 class="mb-3 text-sm font-semibold text-inktext-paper">
          {{ t('admin.accounts.gemini.setupGuide.title') }}
        </h3>
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-inktext-subtle">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-mutedtext-subtle">
          ...
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                class="text-sm text-ink hover:underlinetext-ink"
              >
      ...
      <div class="border-t border-border pt-6">
        ...
        <p class="mb-4 text-xs text-warningtext-warning">
          {{ t('admin.accounts.gemini.quotaPolicy.note') }}
        </p>
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-ink/[0.02]">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-inktext-subtle">
            ...
            <tbody class="divide-y divide-border">
              <tr>
                <td class="px-3 py-2 text-inktext-paper">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.channel') }}
                </td>
                <td class="px-3 py-2 text-mutedtext-subtle">Free</td>
                <td class="px-3 py-2 text-mutedtext-subtle">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-inktext-paper"></td>
                <td class="px-3 py-2 text-mutedtext-subtle">Pro</td>
                <td class="px-3 py-2 text-mutedtext-subtle">
              ...
              <tr>
                <td class="px-3 py-2 text-inktext-paper"></td>
                <td class="px-3 py-2 text-mutedtext-subtle">Ultra</td>
                <td class="px-3 py-2 text-mutedtext-subtle">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-mutedtext-subtle">Standard</td>
                <td class="px-3 py-2 text-mutedtext-subtle">
              ...
              <tr>
                <td class="px-3 py-2 text-inktext-paper"></td>
                <td class="px-3 py-2 text-mutedtext-subtle">Enterprise</td>
                <td class="px-3 py-2 text-mutedtext-subtle">
              ...
              <tr>
                <td class="px-3 py-2 text-inktext-paper"></td>
                <td class="px-3 py-2 text-mutedtext-subtle">Paid</td>
                <td class="px-3 py-2 text-mutedtext-subtle">

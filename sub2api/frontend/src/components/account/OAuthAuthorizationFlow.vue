<template>
  <div
    class="rounded-lg border border-border bg-ink/[0.04] p-4"
  >
      <div class="flex items-start gap-4">
      <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-ink/[0.04]0">
        <Icon name="link" size="md" class="text-paper" />
      </div>
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-ink">{{ oauthTitle }}</h4>
          ...
          <div class="flex flex-wrap gap-4">
            <label class="flex cursor-pointer items-center gap-2">
              <input
                ...
                type="radio"
                value="manual"
                class="text-ink focus:ring-blue-500"
              />
        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="space-y-4">
          <div
            class="rounded-lg border border-ink/40 bg-surface/80 p-4bg-ink/80"
          >
            ...
            <div class="mb-4">
              <label
                class="mb-2 flex items-center gap-2 text-sm font-semibold text-inktext-subtle"
              >
                <Icon name="key" size="sm" class="text-ink" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="rounded-full bg-ink/[0.04]0 px-2 py-0.5 text-xs text-paper"
                >
              ...
              <p
                v-if="parsedRefreshTokenCount > 1"
                class="mt-1 text-xs text-inktext-ink"
              >
            ...
            <div
              v-if="error"
              class="mb-4 rounded-lg border border-danger/30 bg-danger/[0.04] p-3"
            >
              <p class="whitespace-pre-line text-sm text-dangertext-danger">
                {{ error }}
              </p>
            </div>
        ...
        <div v-if="inputMethod === 'cookie'" class="space-y-4">
          ...
          >
            ...
            <div
              ...
              class="mb-4 rounded-lg border border-warning/30 bg-warning/[0.06] p-3"
            >
              <h5 class="mb-2 font-semibold text-warning">
                {{ t('admin.accounts.oauth.howToGetSessionKey') }}
              </h5>
              <ol
                class="list-inside list-decimal space-y-1 text-xs text-warning"
              >
              ...
              <p
                class="mt-2 text-xs text-warningtext-warning"
        ...
        <div v-if="inputMethod === 'manual'" class="space-y-4">
          ...
          >
            <div class="flex items-start gap-3">
              <div
                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-ink/[0.04] text-xs font-bold text-paper"
              >
                1
              </div>
              <div class="flex-1">
                <p class="mb-2 font-medium text-ink">
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-ink hover:text-inktext-ink"
                    >
                ...
                <div v-else class="space-y-3">
                  <div class="flex items-center gap-2">
                    <input
                      ...
                      readonly
                      type="text"
                      class="input flex-1 bg-ink/[0.02] font-mono text-xs"
                    />
                    <button
                      type="button"
                  ...
                  <button
                    type="button"
                    class="text-xs text-ink hover:text-inktext-ink"
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <div
                  v-if="isOpenAI"
                  class="mt-2 rounded border border-warning/40 bg-warning/[0.06] p-3"
                >
                  <p
              ...
              <div class="flex-1">
                ...
                <div>
                  <label class="input-label">
                    <Icon name="key" size="sm" class="mr-1 inline text-ink" />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea
                  ...
                  ></textarea>
                  <p class="mt-2 text-xs text-mutedtext-subtle">
                  ...
                  <div
                    ...
                    class="mt-3 rounded-lg border-2 border-warning/30 bg-warning/[0.06] p-3"
                  >
                    <div class="flex items-start gap-2">
                      <Icon
                        name="exclamationTriangle"
                        size="md"
                        class="flex-shrink-0 text-warningtext-warning"
                        :stroke-width="2"
                      />
                ...
                <div
                  v-if="error"
                  class="mt-3 rounded-lg border border-danger/30 bg-danger/[0.04] p-3"
                >
                  <p class="whitespace-pre-line text-sm text-dangertext-danger">
                    {{ error }}
                  </p>

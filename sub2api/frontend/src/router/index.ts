...
const routes: RouteRecordRaw[] = [
  // ==================== TEMPORARY: design system playground & comps ====================
  // Remove after Milestone C is done.
  {
    path: '/__design',
    name: 'DesignPlayground',
    component: () => import('@/design/__playground.vue'),
    meta: { requiresAuth: false, title: 'Design Playground' }
  },
  {
    path: '/__design/landing',
    name: 'DesignLandingComp',
    component: () => import('@/design/__landing-comp.vue'),
    meta: { requiresAuth: false, title: 'Landing · Design Comp' }
  },
  {
    path: '/__design/dashboard',
    name: 'DesignDashboardComp',
    component: () => import('@/design/__dashboard-comp.vue'),
    meta: { requiresAuth: false, title: 'Dashboard · Design Comp' }
  },
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'CloudCodeAPI'

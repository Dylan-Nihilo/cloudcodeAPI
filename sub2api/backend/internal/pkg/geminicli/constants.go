...
const (
	...
	// GeminiCLIOAuthClientIDEnv / GeminiCLIOAuthClientSecretEnv provide the built-in Gemini CLI
	// OAuth credentials at runtime. The repo intentionally does not embed them.
